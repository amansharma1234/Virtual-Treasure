...
public class Boggle extends Activity implements OnClickListener {
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      setContentView(R.layout.main_boggle_single);
   ...
   public void onClick(View v) {
      ...
      case R.id.continue_button:
         startGame(GameBoggle.KEY_BOARD);
         break;
         // ...
      ...
      case R.id.new_button:
    	  ...
    	  Intent ig = new Intent(this, GameBoggle.class);
          startActivity(ig);
         break;
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
      ...
      case R.id.settings:
         startActivity(new Intent(this, PrefsBoggle.class));
         return true;
...
//   }
   ...
   private void startGame(String i) {
      ...
      Intent intent = new Intent(this, GameBoggle.class);
